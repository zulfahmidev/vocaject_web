      ...
      <div class="col-span-2">
        <div class="bg-white shadow reounded">
          ...
          <div class="py-3 px-5">
            ...
            <div class="mb-3">
              <div class="">Nama</div>
              <input type="text" v-model="form.name" placeholder="nama..." class="py-3 px-4 border rounded outline-none w-full">
            </div>
            <div class="mb-3">
              <div class="">No Telepon</div>
              <input type="text" v-model="form.phone" placeholder="no telepon..." class="py-3 px-4 border rounded outline-none w-full">
            </div>
            <div class="mb-3">
              <div class="">Alamat</div>
              <input type="text" v-model="form.address" placeholder="alamat..." class="py-3 px-4 border rounded outline-none w-full">
            </div>
            <div class="mb-3">
